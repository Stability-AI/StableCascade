...
class Base:
    ...
    def __new__(cls, **kwargs):
        ...
        invalid_kwargs = [
            ...
            if k not in setteable_fields
            or v == EXPECTED
            or (v == EXPECTED_TRAIN and training is not False)
        ]
        print(mandatory_fields)
        assert not invalid_kwargs, f"Invalid fields detected when initializing this DTO: {invalid_kwargs}.\nDeclare this field and set it to None or EXPECTED in order to make it setteable."
    ...
    def setteable_fields(cls, **kwargs):
        return [
            ...
            or isinstance(f.default, _MISSING_TYPE)
            or f.default == EXPECTED
            or f.default == EXPECTED_TRAIN
        ]
    ...
    def mandatory_fields(cls, **kwargs):
        ...
        return [
            ...
            or f.default == EXPECTED
            or (f.default == EXPECTED_TRAIN and training is not False)
        ]
