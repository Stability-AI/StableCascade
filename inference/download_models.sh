...
case $second_argument in
    big-big)
        if [ "$binary_decision" == "bfloat16" ]; then
            ...
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_b_bf16.safetensors -P models/ -q --show-progress
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_c_bf16.safetensors -P models/ -q --show-progress
        else
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_b.safetensors -P models/ -q --show-progress
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_c.safetensors -P models/ -q --show-progress
        fi
        ;;
    big-small)
        if [ "$binary_decision" == "bfloat16" ]; then
            ...
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_b_bf16.safetensors -P models/ -q --show-progress
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_c_lite_bf16.safetensors -P models/ -q --show-progress
        else
            echo "Downloading Large Stage B & Small Stage C"
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_b.safetensors -P models/ -q --show-progress
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_c_lite.safetensors -P models/ -q --show-progress
        fi
        ;;
    small-big)
        if [ "$binary_decision" == "bfloat16" ]; then
            echo "Downloading Small Stage B & Large Stage C (BFloat16)"
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_b_lite_bf16.safetensors -P models/ -q --show-progress
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_c_bf16.safetensors -P models/ -q --show-progress
        else
            echo "Downloading Small Stage B & Large Stage C"
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_b_lite.safetensors -P models/ -q --show-progress
            wget https://huggingface.co/stabilityai/StableWurst/resolve/main/stage_c.safetensors -P models/ -q --show-progress
        fi
        ;;
    small-small)
